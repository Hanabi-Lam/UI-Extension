    ...
    public class UIButtonEditor : ButtonEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SirenixEditorGUI.BeginHorizontalToolbar(28);
            {
                ...
                {
                    _uiButton.buttonClickEnum = isSingle ? _uiButton.buttonClickEnum = _uiButton.buttonClickEnum & (~UIButton.ButtonClickEnum.Single) :
                                                           _uiButton.buttonClickEnum = _uiButton.buttonClickEnum | UIButton.ButtonClickEnum.Single;
                ...
                {
                    _uiButton.buttonClickEnum = isDouble ? _uiButton.buttonClickEnum = _uiButton.buttonClickEnum & (~UIButton.ButtonClickEnum.Double) :
                                                           _uiButton.buttonClickEnum = _uiButton.buttonClickEnum | UIButton.ButtonClickEnum.Double;
                ...
                {
                    _uiButton.buttonClickEnum = isLongPress ? _uiButton.buttonClickEnum = _uiButton.buttonClickEnum & (~UIButton.ButtonClickEnum.LongPress) :
                                                           _uiButton.buttonClickEnum = _uiButton.buttonClickEnum | UIButton.ButtonClickEnum.LongPress;
